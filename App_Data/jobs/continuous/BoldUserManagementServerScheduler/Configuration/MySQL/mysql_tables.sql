...
CREATE TABLE {database_name}.SfUMS_SAMLSettings(
	...
	IsAutoLoginEnabled tinyint(1) NULL,
	PRIMARY KEY (Id))
;
...
INSERT into {database_name}.SfUMS_ApplicationType(Type,Id) values('Bold Reports On-Premise Edition',1)
;
...
CREATE INDEX IX_SfUMS_Usr ON {database_name}.SfUMS_User (UserName, Email, DisplayName(255))
;
